export const data = [
  ...
  },
  {
    ...
    bgColor: 'bg-sky-600',
    shadColor: 'shadow-sky-600/50',
    textColor: 'text-gray-800',
    textColorAlt: 'text-sky-600',
    ringColor: 'ring-gray-800',
    buttonColor: 'bg-gray-800',
    linkVideo:
  ...
  },
  {
    title: 'Tailwind CSS',
    type: 'CSS Framework',
    description: 'Tailwind CSS pada dasarnya adalah sebuah utility-first CSS framework untuk membangun user interface custom dengan cepat. Tailwind CSS sangat dapat dikostumisasi, low-level CSS framework yang memberikan kamu semua building block yang kamu butuhkan untuk membuat user interface gaya mu sendiri.',
